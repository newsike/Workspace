    ...
    if (rootNode != null) {
        ...
        if (result == "false") {
            ...
            if (msg != null && msg != undefined && msg != "")
                messageBox.ActionDisplay('身份验证信息', msg);
        }
        else if (result == "true") {
...
function BLL_Start() {
    this.InitCommonUI = function () {
        ...
        netObj.AsyGetRemoteXML('Configs/InspriationWebSysConfig_Management.xml', this.callback_UIXML);
    };
    ...
    this.callback_UIXML = function (xmldata) {
        ...
        $(formNodes).each(function () {
            ...
            $(controls).each(function () {
                ...
                var control_actionurl = $(this).attr("actionurl");
                if (control_isTemplater == TemplateGroupName || control_isTemplater == activePage) {
                    if (control_type == "button" || control_type == "Button") {
                    ...
                    else if (control_type == "file" || control_type == "File") {
                        var dynamicControl_File = new Global_UIControls_File();
                        dynamicControl_File.CreateControl(activeForm, control_name, control_css, control_width, control_height, control_borderwidth, control_bordercolor, control_positionX, control_positionY, control_label);
                        activeControls.Add(control_name, dynamicControl_File);
                    }
                        ...
                        dynamicControl_linklabel.CreateControl(activeForm, control_name, control_positionX, control_positionY, control_label, control_actionurl, control_css);
